...
**Priorité : P0 · Statut : ACTIVE · Dépendances : RUN-002 (DONE).**
...
RUN-001 et RUN-002 sont DONE après fusion des PR #1 et #2. La correspondance fichier-source reste reportée par décision humaine à la recette des assets distribués. Les catalogues 11–12 deviennent locaux et ignorés par Git. RUN-003 est ACTIVE sur `feature/run-003-scale-comparison` : maquette et captures comparatives vérifiées, décision d'échelle et échantillon complet encore attendus. Après 0.1.0, détailler 0.2.0 à partir du résultat réel.
